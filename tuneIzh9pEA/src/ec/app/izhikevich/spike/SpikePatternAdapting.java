...
public class SpikePatternAdapting extends SpikePattern{
	...
	/*public SpikePatternAdapting(ModelSpikePatternData spikePatternData,Izhikevich9pModel model) {
		super(spikePatternData, model);
		if(this.ISIs!=null) {
	 ...
	 */
	/*
	public SpikePatternAdapting(ModelSpikePatternData spikePatternData, 
			double[] spikeTimes, 
			double current, 
			double timeMin, 
			double durationOfCurrent,
			double vR) {		
		super(spikePatternData, spikeTimes, current, timeMin, durationOfCurrent, vR);
		if(this.ISIs!=null) {
			this.ISI0 = getFirstISI();
			this.frequency0 = getFirstFrequency();
		}
	...
	/*
	 * initializer for experimental ASP through ISIs
	 */
	/*public SpikePatternAdapting(ExpSpikePatternData expSpikeData) {
		super(expSpikeData);
		this.sfaISIs = (int) expSpikeData.getNSfaISIs().getValue();
...
*/
	...
	public double getISI0(){return ISI0;}
