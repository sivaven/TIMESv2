...
public class SpikePattern {
	...
	private ModelSpikePatternData spikePatternData;
	...
	*/
	...
	//	double[] ISIs = this.getISIs();		
		...
		double avg_isi = total_isi/ISIs.length;
		double avg_isi_sec = avg_isi * 0.001;
		return 1.0d/avg_isi_sec;
	}
	...
	public void initBurstPattern(double diffFactor){
		this.burstPattern = new BurstPattern(ISIs, diffFactor);
	}
