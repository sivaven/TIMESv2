...
class DataSetOfModels {
	...
	void WriteDatFor3dPlot(String fitFileName){
		try {
			BufferedWriter bw = new BufferedWriter(new FileWriter(fitFileName+".dat"));	
			BufferedWriter bwx = new BufferedWriter(new FileWriter(fitFileName+"_x.dat"));	
			BufferedWriter bwy = new BufferedWriter(new FileWriter(fitFileName+"_y.dat"));	
			for(int i=0;i<models2d.size();i++){	
